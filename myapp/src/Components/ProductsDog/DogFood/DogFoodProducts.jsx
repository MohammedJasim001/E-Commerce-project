...
const DogFoodProducts = ({dogfoods}) => {
  return (
    <div className='md:w-[300px]  shadow-lg className=" bg-white border shadow-black h-[420px] md:h-[350px] border-gray-200 rounded-lg flex flex-col md:ml-8   '>
        ...
        src={dogfoods.image} alt="" />
     <h1 className="mb-2 text-lg md:text-xl font-bold tracking-tight text-gray-900 ">{dogfoods.name}</h1>
     <h1>{dogfoods.description}</h1>
     <h1 className='text-gray-900 text-lg font-semibold'>{dogfoods.price}</h1>
